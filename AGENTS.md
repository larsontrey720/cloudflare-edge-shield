...
- **Cloudflare Auto-Provisioning**: Automatically initialize a local `wrangler.toml` containing necessary database (D1), KV, or routing bindings as soon as a Cloudflare-related project is detected or started, and immediately ensure it is appended to `.gitignore`.
